...
Recherche par VILLE (voir scrape_wellness_gmaps.py pour la version par département).

Entrée  : villes.csv         (colonne "ville" ; une colonne "statut" est ajoutée/mise à jour)
Sortie  : resultats_villes.csv (écriture en temps réel, une ligne par établissement trouvé)
...
RESULTATS_CSV = "resultats_villes.csv"
